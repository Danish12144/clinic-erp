...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/billing', label: 'Billing', icon: Receipt, permission: ['billing.manage', 'billing.view_own', 'billing.view'] },
  ...
  { to: '/expenses', label: 'Expenses', icon: Wallet, permission: ['expenses.manage', 'expenses.record', 'expenses.view'] },
